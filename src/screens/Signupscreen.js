...
const FALLBACK_CATEGORY_OPTIONS = [
  { id: 3, name: "Others" },
  { id: 2, name: "Non-Farm" },
  { id: 1, name: "Farm-based Livelihood" }
];
const FALLBACK_CRP_TYPE_OPTIONS = [
  { id: 5, name: "CRP-EP" },
  { id: 4, name: "Matsya Sakhi" },
  { id: 3, name: "Krishi Udyog Sakhi" },
  { id: 2, name: "Pashu Sakhi" },
  { id: 1, name: "Krishi Sakhi" }
];
  ...
  useEffect(() => {
    ...
    async function loadSignupMasters() {
      try {
        ...
        setCrpTypes(typeData.length ? typeData : FALLBACK_CRP_TYPE_OPTIONS);
      } catch (error) {
        if (active) {
      ...
      >
        ...
        >
          ...
          <View style={styles.formSectionCard}>
            ...
            <View style={styles.signupRow}>
              <View style={styles.signupHalfInput}>
                <Field label={t("Catergories")} required>
                  <OptionSelector
